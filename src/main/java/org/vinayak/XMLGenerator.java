...
public class XMLGenerator {
    ...
    public static void generateSourcesAndSinksXML(String[] paramTypes, List<String> sinkSignatures, String outputPath) {
        ...
        for (int i = 0; i < paramTypes.length; i++) {
            ...
            sb.append("    <method signature=\"DriverStub: ").append(returnType)
